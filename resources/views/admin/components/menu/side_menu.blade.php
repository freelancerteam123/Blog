<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            <li><a><i class="fa fa-newspaper-o"></i> Loại hàng <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li><a href="index.html">Danh sách</a></li>
                    <li><a href="index2.html">Thêm mới</a></li>
                </ul>
            </li>
            <li><a><i class="fa fa-handshake"></i> Nhà cung cấp <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li><a href="index.html">Danh sách</a></li>
                    <li><a href="index2.html">Thêm mới</a></li>
                </ul>
            </li>
            <li><a><i class="fa fa-bath"></i> Sản phẩm <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li><a href="index.html">Danh sách</a></li>
                    <li><a href="index2.html">Thêm mới</a></li>
                </ul>
